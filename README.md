...
- 핵심 기능:
  ...
  - 대출 상환 거래 매핑
  - 고정비/변동비, 필수 고정비, 반복 결제 분류
  - 카테고리 기반 고정비/반복결제 자동분류 및 거래처 기반 대출 자동연결 규칙
  - 메인 대시보드
  - 지출 분석
  - 자산 현황
  - 인사이트
