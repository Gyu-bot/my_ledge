      ...
      <CardContent className="space-y-5 p-4">
        ...
        <div className="rounded-[var(--radius)] border border-[color:var(--color-primary-soft)] bg-[color:var(--color-surface-raised)] px-4 py-4">
          <div className="relative h-10 px-3">
            <div
              className="absolute inset-x-3 top-1/2 h-2 -translate-y-1/2 rounded-full bg-[color:var(--color-primary-soft)]/70"
            ...
            <input
              ...
              className="pointer-events-none absolute inset-x-3 top-1/2 h-2 -translate-y-1/2 appearance-none bg-transparent [&::-moz-range-thumb]:pointer-events-auto [&::-moz-range-thumb]:h-5 [&::-moz-range-thumb]:w-5 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-white [&::-moz-range-thumb]:bg-[color:var(--color-accent)] [&::-webkit-slider-thumb]:pointer-events-auto [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white [&::-webkit-slider-thumb]:bg-[color:var(--color-accent)] [&::-webkit-slider-thumb]:shadow-[0_8px_18px_-10px_rgba(182,65,59,0.28)]"
              style={{ zIndex: 2 }}
            />
            <input
              ...
              className="pointer-events-none absolute inset-x-3 top-1/2 h-2 -translate-y-1/2 appearance-none bg-transparent [&::-moz-range-thumb]:pointer-events-auto [&::-moz-range-thumb]:h-5 [&::-moz-range-thumb]:w-5 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-white [&::-moz-range-thumb]:bg-[color:var(--color-accent-strong)] [&::-webkit-slider-thumb]:pointer-events-auto [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white [&::-webkit-slider-thumb]:bg-[color:var(--color-accent-strong)] [&::-webkit-slider-thumb]:shadow-[0_8px_18px_-10px_rgba(143,48,44,0.28)]"
              style={{ zIndex: 3 }}
            />
          </div>

          <div
            className="mt-3 flex items-center justify-between px-3 text-xs font-medium text-[color:var(--color-text-muted)]"
            data-testid="timeline-edge-labels"
          >
            <span>{months[0]}</span>
