...
const ROUTES = [
  ...
  ['/api/v1/loan-accounts', () => ({
    items: [
      { loan_account_id: 1, lender: '국민은행', product_name: '주택담보대출', display_name_user: '우리집 주담대', display_name: '우리집 주담대', loan_kind: 'equal_principal_interest', loan_start_date: '2023-01-01', loan_maturity_date: '2053-01-01', as_of_date: `${CURRENT}-07`, latest_snapshot_date: `${CURRENT}-07`, is_active: true, is_hidden: false, is_matured: false, is_stale: false, lifecycle_status: 'active', latest_balance: '240000000', last_observed_balance: '240000000', last_observed_principal: null, last_observed_snapshot_date: `${CURRENT}-07`, included_in_active_summary: true, excluded_from_summary_reason: null, stable_identity_status: 'stable_lender_product', stable_identity_reason: null, latest_interest_rate: '3.85' },
      { loan_account_id: 2, lender: '카카오뱅크', product_name: '마이너스 통장', display_name_user: null, display_name: '카카오뱅크 마이너스 통장', loan_kind: 'overdraft', loan_start_date: '2025-03-01', loan_maturity_date: '2027-03-01', as_of_date: `${CURRENT}-07`, latest_snapshot_date: `${CURRENT}-07`, is_active: true, is_hidden: false, is_matured: false, is_stale: false, lifecycle_status: 'active', latest_balance: '23000000', last_observed_balance: '23000000', last_observed_principal: null, last_observed_snapshot_date: `${CURRENT}-07`, included_in_active_summary: true, excluded_from_summary_reason: null, stable_identity_status: 'stable_lender_product', stable_identity_reason: null, latest_interest_rate: '5.2' },
    ],
  })],
